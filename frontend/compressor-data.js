...
(function () {
  ...
  var REFRIGERANTS = [
    ...
    { id: "R454B",   gwp: 466,   trend: "Growing",   flammability: "A2L", use: "미국 Unitary·상업 AC", samsung: { re: "no", ro: "have", sc: "have" }, rivals: "Copeland·Danfoss·LG·GMCC" },
  ...
  var MANUFACTURERS = [
    ...
    { id: "Panasonic",isUs: false, re: "중간",     ro: "강함",     sc: "중간",     catalogYear: 2026, threatLevel: 3, refrigerants: "R410A·R134a·R32·R290·R1234yf·R454C·R744", strategy: "CO2 히트펌프, R1234yf 다변화", monitor: "CO2 인버터, R1234yf 보유 (반기)", url: "https://industrial.panasonic.com/ww/products/motors-compressors/compressors" },
  ...
  var MODELS = [
    ...
    // ===== 경쟁사 Sc R454B — Danfoss DSH (ARI) — 정규화 md §2.3 =====
    M({ mfr:"Danfoss", type:"Sc", app:"HVAC", model:"DSH090", refrigerant:"R454B", drive:"Variable", cc:null, capW:8900, inputW:null, cop:3.03, eer:null, condition:"ARI", status:"양산", gap:"have", confidence:"High", src:"normalization §2.3 / 보완보고서 §6", oilType:"POE", oilCharge:"3.0L", weightKg:58 }),
    M({ mfr:"Danfoss", type:"Sc", app:"HVAC", model:"DSH184", refrigerant:"R454B", drive:"Variable", cc:null, capW:17500, inputW:null, cop:3.10, eer:null, condition:"ARI", status:"양산", gap:"have", confidence:"High", nameNote:"Danfoss 단일 최근접 모델 DSH184(3.6L POE). DSH180E는 DSH090×2 탠덤 어셈블리. COP는 normalization §2.3 DSH180 기준값 유지", src:"normalization §2.3 / 보완보고서 §6", oilType:"POE", oilCharge:"3.6L", weightKg:71.5 }),
    M({ mfr:"Danfoss", type:"Sc", app:"HVAC", model:"DSH240", refrigerant:"R454B", drive:"Variable", cc:227.6, capW:23000, inputW:null, cop:3.18, eer:null, condition:"ARI", status:"양산", gap:"have", confidence:"High", src:"normalization §2.3 / deepresearch-r454b-scroll-tier1 §1.3", oilType:"POE", oilCharge:"6.1L" }),
  ...
  var BENCHMARK_GROUPS = [
    { id:"r454b-ro-ari",      title:"R454B 로터리 Unitary · ARI",     type:"Ro", refrigerant:"R454B", condition:"ARI",   drive:"Variable", metric:"cop", samsungRef:"UF8LB3265F", members:["UF9BL3180F","UF8LB3265F","UF8LB3360F","UF5LB3520F"], note:"당사 R454B는 로터리 Unitary 양산(ARI, 2024 카탈로그). 경쟁사 R454B는 주로 스크롤형 — 동형 직접비교는 LG UniRotary(스펙 비공개)로 제한.", reliability:4 },
    { id:"r454b-sc-var-ari",  title:"R454B 스크롤 · Variable · ARI",  type:"Sc", refrigerant:"R454B", condition:"ARI",   drive:"Variable", metric:"cop", samsungRef:"DS2LD5046F", members:["DS2LD5046F","DSH090","DSH184","DSH240","ZO38KAE-TFD","ZO50KAE-TFD"], note:"당사 스크롤 R454B(DS2LD5046F, ARI COP 3.37)는 2024 카탈로그 이후 개발·양산. Danfoss(3.03~3.18)·Copeland(3.05~3.10) 대비 우위.", reliability:4 },
    ...
    { id:"r32-ro-var",        title:"R32 로터리 · Variable",          type:"Ro", refrigerant:"R32", condition:"ARI", drive:"Variable", metric:"cop", samsungRef:"UB8TN8300F", members:["UB8TN8300F","UB8TA8265F","ATF310D43UMT","ATF400D64UMV","ATQ360D1UMU","ATQ420D1UMU","SH307MV"], note:"⚠️ 조건 불일치: Samsung UB(ARI, COP 3.16~3.31) vs GMCC ATF/ATQ(SEER60, 3.65~3.72) — 측정조건이 달라 직접 순위비교 불가. SEER60은 응축 42.3°C로 ARI(54.4°C)보다 낮아 COP가 높게 측정됨. Highly SH307MV 조건 미확인. 조건 정렬 후 재평가 필요.", reliability:1 },
    ...
    { id:"re-bldc-uplift",    title:"냉장고 Re · BLDC 전환 효과",     type:"Re", refrigerant:"R600a/R134a", condition:"ASHRAE-LBP", drive:"mixed", metric:"cop", samsungRef:"ENV4A5DL2B", members:["ENV4A5DL2B","CD124K-S1ZA","MSA143K-S1B","MSA170K-S1G"], note:"Fixed 0.76 → BLDC 1.97 = +159% (당사 내부 비교).", reliability:4 },
  ];
  ...
  window.COMPRESSOR_DATA = {
    meta: { asOf: "2026-06-23", baseline: "Samsung", confidence: "High–Medium", nextReview: "2026-12-23", sources: 29, currentYear: 2026, samsungCatalog: 2024 },
    tokens: T,
